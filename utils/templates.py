...
def dhl_parcel(filename, images, index, instant_download=False):
    ...
    with col2:
        ...
        # Specify pixel dimensions for cutting
        x_2, y_2, width_2, height_2, rotation_2 = number_input_set(1300, 50, 900, 1600, 270, 2, index)
    ...
    if international_parcel:
        with col3:
            ...
            # Specify pixel dimensions for cutting
            x_3, y_3, width_3, height_3, rotation_3 = number_input_set(510, 145, 635, 880, 0, 3, index)
